import carla
from Control.controller import VehiclePIDController
from PythonAPI.carla.agents.tools.misc import is_within_distance_ahead
from Control.lane_detection.openvino_lane_detector import OpenVINOLaneDetector
import math
import numpy as np
import cv2
from detection.Object_detector import Object_detector
    ...
    def run_step(self,image):
        ...
        if light_state:
            ...
            try:
                ...
                self.Object_detector.show_traffic_light()
