# 可参考 https://blog.csdn.net/weixin_42635914/article/details/125960930
...
try:
    ...
    spawn_point_forward = carla.Transform(carla.Location(x=1, z=2.4), carla.Rotation(0,0,0))
    ...
    # Adjust sensor relative to vehicle
    spawn_point = carla.Transform(carla.Location(x=1, y=0, z=2.4), carla.Rotation(0,30,0))
    # spawn the sensor and attach to vehicle.
